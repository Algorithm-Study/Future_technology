...
/opt/conda/bin/python /workspace/Future_technology/utils/reset_run.py
...
/opt/conda/bin/python /workspace/Future_technology/utils/out_bbox_crop.py
...
/opt/conda/bin/python /workspace/Future_technology/utils/test_output.py
